...
def main():
    ...
    while passenger_queue:
        ...
        approx_arrival_time = manhattan_est_time(driver.coords, passenger.start_coords)
        approx_drive_time = manhattan_est_time(passenger.start_coords, passenger.end_coords)
