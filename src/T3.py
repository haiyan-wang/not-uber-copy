'''
CURRENTLY IDENTICAL TO T4 (JUST THE FRAMEWORK)

TODO:
    - BRUTE FORCE (OR USE GRID, I DON'T THINK IT MATTERS BUT WE ALREADY HAVE THE GRID CODE) NEAREST NODE ALGORITHM
    - DIJKSTRA'S TO FIND TIME FOR DRIVER TO PICK UP PASSENGER, THEN DROP OFF (SHOULD WE TAKE INTO ACCOUNT DIFFERENT EDGE TIMES?)
        - MAYBE DO THIS WITH MODIFIED VERSION OF HEURISTIC FROM T1/T2, FIND AVERAGE MPH FOR EVERY TIME OF DAY
'''
